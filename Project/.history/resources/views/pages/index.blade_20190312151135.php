...
<section id="calendarSection">
  <div class="container" >
    ...
    @guest
    <div class="row">
      <button type="button" class="btn btn-secondary ml-2 " data-toggle="modal" data-target=".bd-example-modal-lg">Kies een datum </button>
      <small class="d-block">Kies een datum om te gaan werken</small>
    </div>
    @else
