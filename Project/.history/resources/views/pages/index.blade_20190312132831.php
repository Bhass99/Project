...
<section id="calendarSection">
  <div class="container" >
    ...
    <div class="row">
      ...
      <div class="row"> 
        <button type="button" class="btn btn-secondary mr-2" data-toggle="modal" data-target=".bd-example-modal-lg">Voeg een event bij</button>
        <a   href="{{route('displayEvents')}}" class="btn btn-secondary"> Wijzig/Verwijderen</a>
      </div>
    </div>
  </div>
</section>
