...
<section id="calendarSection">
  <div class="container" >
    ...
    @guest
    <div class="w-25" style="border: 1px solid black">
      <button type="button" class="btn btn-secondary " data-toggle="modal" data-target=".bd-example-modal-lg">Kies een datum </button><br>
