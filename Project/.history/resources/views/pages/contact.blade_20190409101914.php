    ...
    <div class="card ">
        <div class="card-header text-center">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mapouter"><div class="gmap_canvas"><iframe width="100%" height="100%" id="gmap_canvas" src="https://maps.google.com/maps?q=Bavoortseweg%2027a%20&t=&z=15&ie=UTF8&iwloc=&output=embed"
                     frameborder="0" ></iframe></div><style>
                     .mapouter{height: 100%; margin: 5% 0}.gmap_canvas {height: 100%;}</style></div>
                </div>
