                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-success">
                                <i class="fas fa-check-square"></i>Accepteren
                            </a><br>
                             <form method="POST" action="{{route('deleteDate', $vol->id)}}">
                                @csrf
                                {{ method_field('DELETE') }}
                                <button type="submit" class="btn btn-danger"><i class="fas fa-edit"></i>Verwijder</button>         
                            </form>
                        </td>
                        <td>
                            &nbsp;
