        ...
        <div class="container">
            @guest
                <div class="gray-balk-text">
                    <a class="credentials" href="#login">Login |</a>
                    <a class="credentials" href="#register">Nog geen account? registreer dan hier!</a>   
                    <a class="credentials" href="#register">contact</a>   
                </div>
                @else
                <div class="loged-in">
