        ...
        <div class="container">
            @guest
                <div class="gray-balk-text">
                    ...
                    <a class="credentials float-left" href="#register">Nog geen account? registreer dan <span class="font-weight-bold">hier!</span></a>   
                    <a class="credentials " href="#contact">contact</a>   
                </div>
                @else
                <div class="loged-in">
